...
public class MongoDBReader extends Reader {
    ...
    public static class Task extends Reader.Task {
        ...
        public void startRead(RecordSender recordSender) {
            ...
            System.out.println("MongoDB:=>startRead by mly");
            ...
            while (dbCursor.hasNext()) {
                ...
                while (columnItera.hasNext()) {
                    ...
                    if (tempCol == null) {
                    ...
                    } else if (tempCol instanceof UUID) {
                        //判断是否是UUID类型
                        //System.out.println(" JUUID:=>" + tempCol.toString());
                        String temcsuuid = GetStringFromCSUUID((UUID) tempCol);
                        //System.out.println("CSUUID:=>" + temcsuuid);
                        record.addColumn(new StringColumn(temcsuuid));
                        ...
                        if (KeyConstant.isArrayType(column.getString(KeyConstant.COLUMN_TYPE))) {
                            ...
                            /*System.out.println("=============" + tempCol.getClass().toString() + "======================");
        ...
        /**
         * 将MongoDB 中的二进制主键转化为C#CSUUID
         */

        public static String GetStringFromCSUUID(java.util.UUID myUuid) {
            ...
            try {
                ...
                result = String.format("%02x%02x%02x%02x-%02x%02x-%02x%02x-%02x%02x-%02x%02x%02x%02x%02x%02x", bytes[4], bytes[5],
                        bytes[6], bytes[7], bytes[2], bytes[3], bytes[0], bytes[1], bytes[15], bytes[14], bytes[13], bytes[12],
